        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            switch (Database.ProviderName)
            {
                case "Microsoft.EntityFrameworkCore.Sqlite":
                    modelBuilder.ApplyConfiguration(new StressPlateConfigurationSqlite());
                    modelBuilder.ApplyConfiguration(new StressRecordConfigurationSqlite());
                    break;
                case "Npgsql.EntityFrameworkCore.PostgreSQL":
                    modelBuilder.HasPostgresExtension("postgis");
                    modelBuilder.ApplyConfiguration(new StressPlateConfigurationPostgreSQL());
                    modelBuilder.ApplyConfiguration(new StressRecordConfigurationPostgreSQL());
                    break;
                case "Microsoft.EntityFrameworkCore.SqlServer":
                    modelBuilder.ApplyConfiguration(new StressPlateConfigurationSqlServer());
